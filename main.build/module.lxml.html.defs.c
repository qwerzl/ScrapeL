...
static PyCodeObject *codeobj_605423a9f4bd63092cf8309da2aaab49;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[2]; CHECK_OBJECT(module_filename_obj);
    codeobj_605423a9f4bd63092cf8309da2aaab49 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[45], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_605423a9f4bd63092cf8309da2aaab49;
    ...
    // Frame without reuse.
    frame_605423a9f4bd63092cf8309da2aaab49 = MAKE_MODULE_FRAME(codeobj_605423a9f4bd63092cf8309da2aaab49, module_lxml$html$defs);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_605423a9f4bd63092cf8309da2aaab49);
    assert(Py_REFCNT(frame_605423a9f4bd63092cf8309da2aaab49) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_605423a9f4bd63092cf8309da2aaab49);
#endif
    popFrameStack();

    assertFrameObject(frame_605423a9f4bd63092cf8309da2aaab49);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_605423a9f4bd63092cf8309da2aaab49, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_605423a9f4bd63092cf8309da2aaab49->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_605423a9f4bd63092cf8309da2aaab49, exception_lineno);
    }
